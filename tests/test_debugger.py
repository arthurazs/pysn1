...
class TestDebugger:
    ...
    def test_identifier_universal(self: "TestDebugger") -> None:
        identifier = Identifier(reference=IdentifierClass.UNIVERSAL, constructed=False, datatype=PrimitiveType.END_OF_CONTENT)
    ...
    def test_identifier_application(self: "TestDebugger") -> None:
        identifier = Identifier(reference=IdentifierClass.APPLICATION, constructed=False, datatype=ApplicationType(value=0))
    ...
    def test_identifier_private(self: "TestDebugger") -> None:
        identifier = Identifier(reference=IdentifierClass.PRIVATE, constructed=False, datatype=PrimitiveType.END_OF_CONTENT)
    ...
    def test_identifier_constructed(self: "TestDebugger") -> None:
        identifier = Identifier(reference=IdentifierClass.UNIVERSAL, constructed=True, datatype=PrimitiveType.END_OF_CONTENT)
        assert identifier.reference == IdentifierClass.UNIVERSAL
    ...
    def test_identifier_application_value(self: "TestDebugger") -> None:
        identifier = Identifier(reference=IdentifierClass.APPLICATION, constructed=False, datatype=ApplicationType(value=1))
        assert identifier.reference == IdentifierClass.APPLICATION
        assert identifier.primitive is True
        assert identifier.constructed is False
